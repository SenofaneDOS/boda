  ...
  <div class="card-container grid grid-flow-col gap-20 justify-center">
    <div class="w-96 shadow-sm hover:shadow-lg rounded-lg bg-white">
      <div class="group w-full h-96 relative">
        <img
          ...
          src="../../assets/images/celebrazione.png"
          alt=""
        >
      </div>
      <div class="grid gap-5 relative z-10 -mt-16 pt-0 text-center">
        <h3 class="text-black text-7xl  bg-gradient-to-t from-white via-white to-transparent">
          Cerimonia
        </h3>
    ...
    <div class="w-96 shadow-sm hover:shadow-lg rounded-lg bg-white">
      <div class="group w-full h-96 relative">
        <img
          class="w-full h-full object-cover block rounded"
          src="../../assets/images/ricevimento.png"
          alt=""
        >
      </div>
      <div class="grid gap-5 relative z-10 -mt-16 pt-0 text-center">
